...
{
    static TextureIndex wak_tex = scene.AddTexture({ .type = image_texture, .filename = "res/wakdu.jpg", .non_color = false });
    ...
    static MaterialIndex glass = scene.AddMaterial<DielectricMaterial>(1.5f, Vec3(0.0f, 0.8f, 0.1f));
